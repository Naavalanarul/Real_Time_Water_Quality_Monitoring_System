// ─── RiverMesh.tsx — Aethera Flow (Light Theme) ──────────────────────────────
// Lighter oceanic palette: deep teal troughs, bright sky-blue crests.
// All geometry, noise, and FBM logic unchanged from spec.
...
export default function RiverMesh() {
  ...
  const uniforms = useMemo(
    () => ({
      ...
      // ── Light theme palette ──────────────────────────────────────────
      // Troughs: medium-dark teal     Peaks: bright sky blue
      uDepthColor:          { value: new THREE.Color("#1a4472") },
      uSurfaceColor:        { value: new THREE.Color("#5dadde") },
